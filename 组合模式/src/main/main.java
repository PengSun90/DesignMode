...
import main.ComponentDemo.Composite;
import main.ComponentDemo.Leaf;
...
public class main {
	...
	public static void main(String[] args) {
		...
		Leaf leaf3 = demo.new Leaf();
		leaf3.name = "左-子节点1";
		Leaf leaf4 = demo.new Leaf();
		leaf4.name = "左-子节点2";
		
		compositeLeft.add(leaf3);
		compositeLeft.add(leaf4);
